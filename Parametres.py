...
def parametres():
    ...
    identificacions = p.read_csv(os.path.join('arrel_entrada','db_imatges','train','annotation.txt'),sep='\t',header=0)
...
def crea_dirs(params):
    dir_out = os.path(params['arrel_sortida'])
